...
class Loader:
    ...
    def run(self):
        ...
        while True:
            ...
            # if self.status == "in_warehouse" and not station1.loaders_count_on_station and station1.station_status:
            #     self.departure_from_warehouse_to_station1()
            #
            #     if station1.loader_to_station and self.status_now == "to_station1" and WAREHOSE_STATION_SIZE2 > station1.details_required:
            ...
            # if self.status == "in_warehouse" and not station2.loaders_count_on_station and station2.station_status:
            #     self.departure_from_warehouse_to_station2()
            #
            #     if station2.loader_to_station and self.status_now == "to_station2" and WAREHOSE_STATION_SIZE2 > station2.details_required:
            ...
            # #TODO: Работает кроме первой станции
            # # Отправление грузчиков на склад
