...
class FrameRenderer(object):
    ...
    def render(self):
        ...
        background_image = pygame.image.load("airport_scheme2.png").convert()
        # Set positions of graphics
        background_position = [0, 0]
        self._screen.blit(background_image, background_position)

        """Отображение текста и переменной на экране"""
        # font = pygame.font.Font(None, 20)
        #
        # text = font.render("Кол-во: ", True, (0, 0, 255))
        # #text2 = font.render(str(stoyanka_counts), True, (0, 0, 255))
        #
        # self._screen.blit(text, [60, 230])9
        # #self._screen.blit(text2, [110, 230])
