...
2 версия модели:
    ...
    .Поиск деталей на складе и оформление заказа с помощью технологий интернета вещей(иерархическая структура)
    .Не известно сколько деталей находится в данный момент на производстве,
                    поэтому поиск и заказ запчастей занимает большее время.
"""
